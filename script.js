const mainTasks = [
    ...
    // 肉類
    "豬腳", "牛腱", "豬肉", "雞胸", "香腸", "火腿", "雞腿", "羊肉", "牛筋", "雞翅",

    // 海鮮類
    "鮑魚", "蝦子", "貝類", "蟹腳", "章魚", "花枝", "透抽", "龍蝦", "鯖魚", "烏魚子",

    // 飲料類
    "汽水", "果汁", "綠茶", "咖啡", "豆漿", "運動飲料", "礦泉水", "啤酒", "紅茶", "乳酸飲料",

    // 乳製品
    "煉乳", "優格", "起司", "鮮奶油", "奶酪", "保久乳", "乳酪",
...
const categories = {
    ...
    // 生鮮冷凍類
    "豬腳": "生鮮冷凍類", "牛腱": "生鮮冷凍類", "豬肉": "生鮮冷凍類", "雞胸": "生鮮冷凍類",
    "香腸": "生鮮冷凍類", "火腿": "生鮮冷凍類", "雞腿": "生鮮冷凍類", "羊肉": "生鮮冷凍類",
    "牛筋": "生鮮冷凍類", "雞翅": "生鮮冷凍類",
    ...
    // 乳製品
    "煉乳": "乳製品", "優格": "乳製品", "起司": "乳製品", "鮮奶油": "乳製品", "奶酪": "乳製品", "乳酪": "乳製品",
